...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    rate_after_fee = exchange_rate * (spread / 100) + exchange_rate
    total_money = exchange_money(budget, rate_after_fee)
    leftover = get_leftover_of_bills(total_money, denomination)
    return int(total_money - leftover)
